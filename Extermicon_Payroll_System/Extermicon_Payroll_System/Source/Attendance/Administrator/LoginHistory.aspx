<%@ Page Title="" Language="C#" MasterPageFile="~/Source/Shared/Site.Master" AutoEventWireup="true" CodeBehind="LoginHistory.aspx.cs" Inherits="Extermicon_Payroll_System.Source.Attendance.Administrator.LoginHistory" %>
    ...
    <div class="container row form-inline">
        <div class="form-group">
            ...
            <div class="input-group" style="width: 30%;">
                ...
                <div class="form-control">
                <telerik:RadComboBox ID="rcmbEmployee" Font-Size="X-Small" Font-Bold="false" CheckBoxes="true" Filter="Contains" AllowCustomText="true" EnableCheckAllItemsCheckBox="true" AutoPostBack="true" AutoCompleteSeparator="|" Skin="Metro" runat="server" DataSourceID="edsEmployeeList" DataTextField="name" DataValueField="emp_id"></telerik:RadComboBox>
...
<%--                    <telerik:GridBoundColumn DataField="hours_over" DataType="System.Double" DataFormatString="{0:n2}" FilterControlAltText="Filter hours_over column" HeaderText="Overtime" SortExpression="hours_over" UniqueName="hours_over">
        ...
        <asp:EntityDataSource ID="edsUserLoginHistory" runat="server" AutoGenerateWhereClause="true" ConnectionString="name=ExtermiconDBEntities" DefaultContainerName="ExtermiconDBEntities" EnableFlattening="False" EntitySetName="vw_log_in_history">
            <WhereParameters>
                <asp:ControlParameter ControlID="rcmbEmployee" Type="Int32" PropertyName="SelectedValue" Name="emp_id" />
